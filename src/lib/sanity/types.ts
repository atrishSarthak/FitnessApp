...
// Query: *[_type == "exercise" && isActive == true] | order(name asc) {  _id,  name,  description,  difficulty,  "imageUrl": image.asset->url,  videoUrl}
...
// Query: *[_type == "exercise" && _id == $id][0] {    _id,    name,    description,    difficulty,    "imageUrl": image.asset->url,    videoUrl,    isActive  }
